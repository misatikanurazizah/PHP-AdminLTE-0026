...
<head>
  ...
  <title>Aplikasi Toko 0026</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/Index.php.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">TOKO AZIZAH</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>&copy; <span id="year"></span> <a href="#">Mis Atika Nur Azizah</a>.</strong> All rights reserved.
  </footer>
